...
public class courses_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        course_code=bundle.getString("code");
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_courses_detail, container, false);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
           ...
           // return PlaceholderFragment.newInstance(position + 1);
            ...
            bundle.putString("code",course_code);
            if(position==3) {
                Fragment f=new courses_assignments();
                f.setArguments(bundle);
                return f;
            }

            else if(position==1){
                Fragment f=new courses_resources();
                f.setArguments(bundle);
                return f;
            }
            else if(position==0){
                Fragment f=new courses_grades();
                f.setArguments(bundle);
                return f;
            }
            else{
                Fragment f=new courses_threads();
                f.setArguments(bundle);
                return f;
            }
        }
