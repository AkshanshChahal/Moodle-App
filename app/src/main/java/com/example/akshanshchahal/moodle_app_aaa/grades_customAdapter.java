 ...
 */
public class grades_customAdapter extends ArrayAdapter<String[]>{
    public grades_customAdapter(Context context,ArrayList<String[]> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView_marks = myInflator.inflate(R.layout.grades_customrow, parent, false);
        ...
        TextView course = (TextView) customView_marks.findViewById(R.id.marks_courseName);
        ...
        course.setText(strings[0]);
        score.setText(strings[2]);
        weight.setText(strings[3]);
        absMarks.setText(strings[4]);
        gradeItem.setText(strings[1]);
